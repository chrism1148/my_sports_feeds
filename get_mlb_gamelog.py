...
year = 2019
days = [datetime.datetime(year, 6, 8) + datetime.timedelta(days=i) for i in range(1)]
days = [day for day in days]
game_date = [day.strftime("%Y%m%d") for day in days]


for date in game_date:
	json_gamelog = msf.msf_get_data(league='mlb',season='2019-regular',feed='daily_player_gamelogs' ,format='json', date=str(date))
